...
const UploadPerkelas: React.FC<UploadPerkelasProps> = ({ onBack }) => {
  ...
  const handleDownloadTemplate = () => {
    ...
    const prl = currentClass ? currentClass.paralel : selectedKelas.replace(/[0-9]/g, '') || 'A';
    ...
    toast.success('Template berhasil diunduh!', { icon: '📥' });
  };
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={async () => {
              ...
              setIsSaving(false);
              toast.success('Data tersimpan dan disinkronisasi!');
            }}
            disabled={isSaving}
